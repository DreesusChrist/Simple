...
8% fee, used for buybacks (5%) and dao (3%)
...
contract Simple is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable()); // Marketing Address
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xA91D4Dc9C8007ef3061183D3f98B0e71950681bA);
